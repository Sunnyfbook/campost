...
BOT_TOKEN = environ.get('BOT_TOKEN', "8117558252:AAFhfcCSiZGpWW6eERzX_SODDMCVf3w5vzc")
BOT_USERNAME = environ.get("BOT_USERNAME", 'CamGrabberInsta_bot') # without @ 

# Admins, Channels & Users
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1003051710521')) # admin your channel in stream 
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002936465356')) # admin your channel in users log 
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sunnyfbook3_db_user:Zv94aP0DxwRJItI1@cluster0.eotpcjf.mongodb.net/?retryWrites=true&w=majority")
